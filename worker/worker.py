...
# ---------------------------------------------------------------------------
# Proxy / route layer (2026-09-14, revised 2026-09-15)
#
...
#                  network (http:// or socks5h://).  It is tried FIRST: the PCs'
#                  plain direct route to sequencing archives is far too slow
#                  (measured ~0.1 MiB/s direct vs ~1.5 MiB/s through the proxy).
...
def _is_loopback(host):
    """True for literal loopback addresses (127.0.0.0/8, ::1)."""
    try:
